...
namespace Edu_System_BackEnd.Migrations
{
    ...
    [Migration("20250317150142_ReworkTables")]
    partial class ReworkTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Edu_System_BackEnd.Edu_System_BackEnd.Core.Entities.Subject", b =>
                {
                    b.HasOne("Edu_System_BackEnd.Edu_System_BackEnd.Core.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("Edu_System_BackEnd.Edu_System_BackEnd.Core.Entities.Subject", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subjects_users_id");
                });
